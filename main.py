...
- No excessive messages in a row
- No excessive mentions
- No excessive messages in a short time
- No self-promotion
- No advertising
- No excessive use of bot commands
- No excessive writing of rules (looking at you CoPilot)

- Write messages in order
- Pls prefix your msgs with your name

^ mostly generated by copilot

sol - oml
sol - also i responded to your email, i can paste here if you prefer
vin - algs, i have outlook open
sol - sweet
vin - yeah fair, hardest part would be comms with the server lol
vin - i think i have a solution for that "copilot has a solution to 'everything'"
sol - pffff, lemme find the script
vin - bet
sol - im gonna make a link for a vs workspace
vin - https://github1s.com/sololearn-coders/Outlook-Email-Server-Comms < bro what is this copilot on drugs
sol - wtf
vin - bro its an online vscode github smth
sol - jeeze
sol - heres the link
sol - https://prod.liveshare.vsengsaas.visualstudio.com/join?D7CBE1D2D013F3E2158480812B0DA847B269
vin - doesnt work tho bc the github page is gone lol
sol - lol
'''
